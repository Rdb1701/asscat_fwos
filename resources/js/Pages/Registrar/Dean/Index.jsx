...
export default function Dashboard({ auth, dean_account, success }) {
    ...
    const handleForm = async (e) => {
        ...
        try {
            await post(route("dean_account.changepassword", data.user_id), {
                onSuccess: () => {
                    setOpenModal(false);
                },
                onError: () => {
    ...
    const handleDelete = (dean) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('deanAccount.destroy', dean.id));
                Swal.fire(
                    'Deleted!',
    ...
    return (
        ...
        >
            <Head title="Dean Account Management" />
                                    ...
                                    <tbody>
                                        {dean_account.map((dean) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    {dean.department_name
                                                        ?"College Dean ["+ dean.department_name + "]"
                                                        : "Deleted College"}
                                                </td>
                                                <td className="px-4 py-3">
                                                    <div className="flex space-x-2">
                                                        ...
                                                        <button
                                                            ...
                                                            aria-label={`Changepass ${dean.name}`}
                                                        >
