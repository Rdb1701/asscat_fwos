...
export default function Dashboard({ auth, chair_account, success }) {
    ...
    const handleForm = async (e) => {
        ...
        try {
            await post(route("chair_account.changepassword", data.user_id), {
                onSuccess: () => {
                    setOpenModal(false);
                },
                onError: () => {
    ...
    const handleDelete = (chair) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('chairAccount.destroy', chair.id));
                Swal.fire(
                    'Deleted!',
    ...
    return (
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        Chairperson Account Management
                    </h2>

                    <Link
                        href={route("chairAccount.create")}
        ...
        >
            <Head title="Chairperson Account Management" />
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex space-x-2">
                                                        ...
                                                        <button
                                                            ...
                                                            aria-label={`Changepass ${chair.name}`}
                                                        >
